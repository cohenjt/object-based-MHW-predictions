...
### Citation
Cohen, J. T., Thompson, L., Maroon, E., Deppenmeier, A., Cai, C., Object-based evaluation of marine heatwave predictions, _submitted to GRL_
...
- `MODE_scripts`
    - Contains example scripts for running MODE on NCAR's Casper machine.